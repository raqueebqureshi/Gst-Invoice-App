  ...
  return (
    <div style={{
      ...
      <div style={{ marginTop: '20px' }}>
        <h2 style={{ margin: 0, fontSize: '20px' }}>{shopdetails[0].name !== null 
        ? shopdetails.name : "Shop Name"}</h2>
        <p style={{ margin: '5px 0' }}>{shopdetails[0].address1 !== null 
        ? shopdetails[0].address1 : "N/A"},
        ...
        <p style={{ margin: '5px 0' }}>Email ID: {shopdetails[0].email !== null ? shopdetails[0].email : "N/A"}</p>
      ...
      <div style={{
        ...
        <div style={{ flex: 1, padding: '10px', backgroundColor: '#e6f2ff' }}>
          ...
          <p style={{ margin: '5px 0' }}>{orders[0].billing_address.name !== null 
          ? orders[0].billing_address.name : "N/A"} </p>
          <p style={{ margin: '5px 0' }}>ADDRESS: {orders[0].billing_address.address1 !== null 
          ? orders[0].billing_address.address1 : "N/A"}</p>
          <p style={{ margin: '5px 0' }}>{orders[0].billing_address.address2 !== null 
          ? orders[0].billing_address.address2 : "N/A"}, {orders[0].billing_address.city !== null 
          ? orders[0].billing_address.city : "N/A"}, {orders[0].billing_address.province !== null 
          ? orders[0].billing_address.province : "N/A"} - {orders[0].billing_address.zip !== null 
          ? orders[0].billing_address.zip : "N/A"}</p>
          <p style={{ margin: '5px 0' }}>Email ID: {orders[0].email !== null 
          ? orders[0].email : "N/A"}</p>
          {/* <p style={{ margin: '5px 0' }}>GSTIN: 07AAFCD5862R1Z8</p> */}
        </div>
        <div style={{ flex: 1, padding: '10px', backgroundColor: '#e6f2ff' }}>
          <h3 style={{ margin: 0, fontSize: '16px' }}>Ship To:</h3>
          <p style={{ margin: '5px 0' }}>{orders[0].shipping_address.name !== null 
          ? orders[0].shipping_address.name : "N/A"} </p>
          <p style={{ margin: '5px 0' }}>ADDRESS: {orders[0].shipping_address.address1 !== null 
          ? orders[0].shipping_address.address1 : "N/A"}</p>
          <p style={{ margin: '5px 0' }}>{orders[0].shipping_address.address2 !== null 
          ? orders[0].shipping_address.address2 : "N/A"}, {orders[0].shipping_address.city !== null 
          ? orders[0].shipping_address.city : "N/A"}, {orders[0].shipping_address.province !== null 
          ? orders[0].shipping_address.province : "N/A"} - {orders[0].shipping_address.zip !== null 
          ? orders[0].shipping_address.zip : "N/A"}</p>
          <p style={{ margin: '5px 0' }}>Email ID: {orders[0].email !== null 
          ? orders[0].email : "N/A"}</p>
          {/* <p style={{ margin: '5px 0' }}>GSTIN: 07AAFCD5862R1Z8</p> */}
        </div>
            ...
            <tbody>
    {
      ...
      <div style={{
        ...
        <div style={{ flex: 1, backgroundColor: '#e6f2ff', padding: '10px' }}>
          ...
          <ol style={{ paddingLeft: '0px', margin: '10px 0' }}>
          ...
          <table style={{ width: '100%', borderCollapse: 'collapse' }}>
            <tbody>
              ...
              <tr>
                ...
                <td style={{ border: '1px solid #000', padding: '8px' }}>{orders[0].total_outstanding}</td>
              </tr>
