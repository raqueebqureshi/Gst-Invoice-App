...
const UpgradeBanner = ({title, msg, buttonTitle, buttonClick}) => {
    ...
    <>
      {isBannerVisible && (
        <Banner
          ...
          status="warning"
          action={{
            content: <a href="/plans_and_billings" style={{textDecoration: 'none', color: 'black'}}>{buttonTitle || 'Upgrade Plan'}</a>,
